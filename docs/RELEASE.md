...
2. `npm run http:start` 또는 로그온 작업으로 서버가 떠 있는지 본다.
3. [`../tests/release/mcp-http.md`](../tests/release/mcp-http.md)를 체크한다.
4. Cursor를 재시작한 뒤 공간 목록·할일 조회를 한 번 한다.
